...
import FriendSearch from "./home/Home";
      ...
      <nav className="flex justify-between items-center w-[80%] mx-auto my-[20px]">
            ...
            {state.user && (
              <div className="flex flex-col gap-[30px]">
                <FriendSearch />
                  ...
                  <div className="hover:text-indigo-500 pl-8 font-semibold text-lg gabarito-regular cursor-pointer">
                    {state.user.email}
                  </div>
                  ...
                  <div
                    onClick={handleClick}
                    className="hover:text-indigo-500 pl-8 font-semibold text-lg gabarito-regular cursor-pointer"
                  >
                    Logout
                  </div>
        ...
        <div className="hidden sm:block">
          <ul className="list-none flex gap-x-12">
            ...
            {state.user && (
              <div className="list-none flex justify-center items-center gap-x-12">
                <FriendSearch />
